  ...
  return (
    <div>
...

        {
         ...
         temp && temp>20 &&
         ( <div>
           <p> <span style={{color:"red"}}>Temparature: {temp}</span></p>
           <p> <span style={{color:"red"}}>Conditions: "{weather}"</span></p>
            </div>
          )
}
  {
          ...
          (
            ...
            <div>
              <p>
              <span style={{color:"blue"}}>Temparature: {temp}</span></p>
           <p> <span style={{color:"blue"}}>Conditions: "{weather}"</span></p>
            </div>
