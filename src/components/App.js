  ...
  return (
    <div>
...

        {
         ...
         temp && temp>20 &&
         ( <div>
            <p style={{color:"red"}}>Temparature: {temp}</p>
            <p style={{color:"red"}}>Conditions: "{weather}"</p>
            </div>
          )
}
  {
          ...
          (
            ...
            <div>
              <p style={{color:"blue"}}>Temparature: {temp}</p>
            <p style={{color:"blue"}}>Conditions: "{weather}"</p>
            </div>
